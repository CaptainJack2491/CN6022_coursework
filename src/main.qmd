...
- **Barnard's Star**: The first outlier in our table (Source ID `4472832130942575872`, total_motion `~10,393`) is almost certainly Barnard's Star, which has the highest proper motion of any known star.
- **The 100pc limit**: Min parallax is ~10.0, which corresponds exactly to a distance of 100 parsecs ($d = 1000/ \pi$), matching our filename gaia_100pc.
